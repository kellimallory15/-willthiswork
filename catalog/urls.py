...
from . import views
from .views import CustomGalleryListView, CustomPhotoDetailView, remove_from_cart
...
urlpatterns = [path('admin/', admin.site.urls),
               ...
               path('remove_from_cart/<int:booking_id>/', remove_from_cart, name='remove_from_cart'),
               ...
               path('order_information_input/', views.order_information_input, name="order_information_input"),  # new
